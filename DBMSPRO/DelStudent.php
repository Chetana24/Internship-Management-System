<?php 
	...
	define('DB_PASSWORD','');  
 	...
 	if(isset($_POST['delete'])){
 		$id = $_POST['userid'];
		$sql = mysqli_query($con,"DELETE FROM student WHERE USN = '$id';");
		if($sql==0){
...
<body>
	...
	<div class="bg-image" ></div>
		...
		<div class="del">
			<br>
			<p style="font-size:24px;color:#ffb13e;"> <b> DELETE STUDENT </b> </p> 
			<p style="color:white;">  </p>
			<input type="text" name="userid" placeholder="Enter USN" required ">
			<br> <br>
