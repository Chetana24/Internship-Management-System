...
<body>
	<form method="post" action="GraduationYrView.php"
	<div class="bg-image" ></div>
		...
		<div class="grad">
			<br>
			<p style="font-size:24px;color:#ffb13e;"> <b>  STUDENT LIST </b> </p> 
			<p style="color:white;"> GRADUATION YEAR </p>
			<input type="text" name="GraduationYear" placeholder="Enter Graduation Year" required ">
			<br> <br>
