...
<body>
	<form method="post" action="StdInternshipView.php">
	<div class="bg-image" ></div>
		...
		<div class="place">
			<br>
			<p style="font-size:23px; font-family:sans-serif;"> <b> VIEW INTERNSHIP DETAILS </b> </p> 
			<input type="text" name="id" placeholder="Enter Inernship ID" required ">
			<br> <br>
			<input type="submit" name="submit" value="Internship Details">
		</div>
</form>
</body>
</html>